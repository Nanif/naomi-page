            ...
            <div class="card-body"><h5 class="card-title">Inline</h5>
              <div>
                <form class="form-inline">
                  <div class="mb-2 ml-sm-2 mb-sm-0 position-relative form-group"><label for="exampleEmail22" class="ml-sm-2">Email</label><input name="email" id="exampleEmail22" placeholder="something@idk.cool" type="email" class="form-control">
                  </div>
                  <div class="mb-2 ml-sm-2 mb-sm-0 position-relative form-group"><label for="examplePassword22" class="ml-sm-2">Password</label><input name="password" id="examplePassword22" placeholder="don't tell!" type="password"
